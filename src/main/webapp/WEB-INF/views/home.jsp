   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" action="loginTest" method="post">
            <div class="form-group">
              <input type="text" placeholder="Email" name="mEmail" class="form-control">
            </div>
            <div class="form-group">
              <input type="password" name ="mPassword" placeholder="Password" class="form-control">
            </div>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" href="join_member" role="button">회원가입 &raquo;</a></p>
